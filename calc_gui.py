...
class Calculator:
    def __init__(self, master):
        ...
        self.screen = Text(master, state='disabled', width=100, height=10, background="yellow", foreground="blue")

        # position screen in window
        self.screen.grid(row=0, column=0, columnspan=8, padx=10, pady=10)
    ...
    def createButton(self, val, write=True, width=20):
